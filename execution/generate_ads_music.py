#!/usr/bin/env python3
"""
Generate background music for Good vs Bad Ads video using Google Lyria RealTime.

Usage:
  python execution/generate_ads_music.py

Output:
  tiktok-recreation/public/background-music-ads.mp3
"""
        ...
        await session.set_weighted_prompts(
            prompts=[
                types.WeightedPrompt(
                    text="energetic modern electronic beats, punchy percussive, ad education content, confident swagger",
                    weight=1.0,
                ),
                types.WeightedPrompt(
                    text="dark minimal bass, trap hi-hats, clean crisp production, social media ad music",
                    weight=0.7,
                ),
            ]
        )
